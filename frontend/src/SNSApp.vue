            ...
            <v-navigation-drawer app clipped flat v-model="sideBar">
                <v-list>
                    ...
                    <v-list-item
                        class="px-2"
                        key="productions"
                        to="/productionManagements/productions"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="logistics"
                        to="/logisticsManagements/logistics"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
...
export default {
    ...
    data: () => ({
        ...
        aggregate: [
            { 
                title: '주문', 
                description: '고객이 주문한 생선 제품 주문 정보를 담당하는 Aggregate', 
                key: 'orders', 
            ...
            { 
                title: '생산', 
                description: '생선 생산 계획 및 생산 요청을 담당하는 Aggregate', 
                key: 'productions', 
                route: '/productionManagements/productions',
                ImageUrl: '',
            },
            { 
                title: '물류', 
                description: '생산된 생선의 저장 및 배송 처리를 담당하는 Aggregate', 
                key: 'logistics', 
                route: '/logisticsManagements/logistics',
                ImageUrl: '',
            },
            { 
                title: '영업', 
                description: '영업 계약 및 주문 정보를 담당하는 Aggregate', 
                key: 'sales', 
                route: '/salesManagements/sales',
                ImageUrl: '',
            },
